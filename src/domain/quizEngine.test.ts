...
const question: Question={id:'q1',subjectId:'s',quizId:'z',stem:'Stem',choices:[{id:'A',text:'A'},{id:'B',text:'B'}],verifiedAnswer:'B',answerSource:'verified',rationale:'Rationale',metadata:{}};
